...
from .datasets import  MultiViewEchoSegmentationDataset
...
def _parse_dataset_str(dataset_str: str):
    ...
    if name == "Echo":
        class_ = EchoImageDataset
    elif name == "EchoSegmentation":
        class_ = EchoSegmentationDataset
    # elif name == "EchoVideoSegmentationDataset":
    #     class_ = EchoVideoSegmentationDataset
    elif name == "ImageNet":
        class_ = ImageNet
        if "split" in kwargs:
...
def make_dataset(
    *,
    ...
    dataset = class_(split =split, transform=transform, target_transform=target_transform, transforms=transforms, **kwargs)
...
def make_data_loader(
    *,
    ...
    logger.info(f"using PyTorch data loader with sampler: {sampler}" )
