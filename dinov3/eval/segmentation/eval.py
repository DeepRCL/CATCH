...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--dataset", type=str, default="private_echo",
                        choices=["private_echo", "camus", "echonet"])
    parser.add_argument("--start-ckpt", type=str, required=True)
    parser.add_argument(
        "--base-config-path",
        type=str,
        default="/home/bassant/code/Modified_code_MV_SEG/eval_echo_linear.yaml",
    )
