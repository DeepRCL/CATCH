...
# from dinov3.eval.segmentation.offline_embeddings import train_segmentation
...
def run_segmentation_with_dinov3(
    ...
    wandb.init(project="dinov3", name=f"measurments_Weighted_Dice_CE_segmentation_linear_prob_13_labels_withl2_loss_continue_training_{config.wandb_name}_Upsample_RV")
    if config.load_from:
